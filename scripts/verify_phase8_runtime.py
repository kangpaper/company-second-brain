...
def main() -> None:
    ...
    database_name = f"company_brain_phase8_{uuid.uuid4().hex[:10]}"
    ...
    try:
        ...
        while time.monotonic() < deadline:
            ...
            try:
                response = httpx.get("http://127.0.0.1:8023/health", timeout=1)
        ...
        result = subprocess.run(
            [
                ...
                str(root / "scripts" / "phase8_customer_360_runtime_smoke.py"),
            ],
            cwd=root,
            env=environment,
            check=False,
        ...
        if result.returncode != 0:
            ...
            raise RuntimeError(f"Phase 8 smoke failed:\n{details[-4000:]}")
        ...
        print("phase8_runtime_database_dropped=true")
