...
def main() -> None:
    ...
    database_name = f"company_brain_phase12_{uuid.uuid4().hex[:10]}"
    ...
    try:
        ...
        _run_checked(
            [alembic, "downgrade", "e21f4a7c9b30"],
            root=root,
        ...
        _run_checked(
            [
                ...
                "-m",
                "pytest",
                "apps/api/tests/acceptance/test_action_proposals_api.py",
                "apps/api/tests/integration/test_action_proposals_postgres.py",
                "-q",
            ],
            root=root,
            environment=environment,
        ...
        _run_checked(
            [python, str(root / "scripts" / "phase12_action_runtime_smoke.py")],
            root=root,
            environment=environment,
        )
        print("phase12_fresh_zero_to_head=passed")
        print("phase12_migration_round_trip=passed")
        print("phase12_alembic_drift=none")
        print("phase12_postgresql_contract=passed")
        print(f"phase12_tcp_runtime_port={runtime_port}")
        print("phase12_tcp_runtime=passed")
    finally:
        ...
        print("phase12_runtime_database_dropped=true")
