...
def main() -> None:
    ...
    database_name = f"company_brain_phase9_{uuid.uuid4().hex[:10]}"
    ...
    try:
        ...
        while time.monotonic() < deadline:
            ...
            try:
                response = httpx.get("http://127.0.0.1:8024/health", timeout=1)
        ...
        result = subprocess.run(
            [
                ...
                str(root / "scripts" / "phase9_context_runtime_smoke.py"),
            ],
            cwd=root,
            env=environment,
            check=False,
        ...
        if result.returncode != 0:
            ...
            raise RuntimeError(f"Phase 9 smoke failed:\n{details[-4000:]}")
        ...
        print("phase9_runtime_database_dropped=true")
